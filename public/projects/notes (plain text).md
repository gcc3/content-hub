...
Note takers focus on the note, once a note is saved (to git), it is preserved.  
You can easily sync it with Dropbox, Google Drive, iCloud...  
Over the years, plain text notes have become my primary method for taking notes,  
I created hundreds of these text-based notes.  
